...
#if alpha > 1: N_array = N_array[7:]
#elif alpha>0 and alpha<1: N_array = N_array[:8]
...
def plot_corrxt(ni,n):
    ...
    for ti,t in enumerate(Tth_step): #np.arange(0,T):
        ...
        if t in [50,100,150,200,250,300,400,500]:#,125,150,200,250]:
        ...
        if t in [1000,1100,1200,1300,1400, 1500]: #[1200,1210,1220,1230,1240, 1250]:
    ...
    plt.savefig('./plots/CxtN_vs_x_L{}_{}_{}_{}_{}configs_{}.pdf'.format( L, param, epstr[epss], alphastr, countfiles, versions[n]))
