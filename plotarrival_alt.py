...
if Mu == 1 and Lambda ==0:
    param = 'qwdrvn'; last_site = 320; first_site = 20 	#another choice could be 100-400
if Mu == 0 and Lambda ==1:
    param = 'qwhsbg'; last_site = 320; first_site = 20
if Mu ==1 and Lambda ==1:
    param = 'qwa2b0'; last_site = 320; first_site = 20
...
def get_arrivaltime(begin,end): #(dtsymb,begin,end) if multiple dtstr arrays to be concatenated
    ...
    filerepo = '{}_tvx_{}_{}_{}_out.txt'.format(param,dtstr,thresh,epstr); #thresh
...
def plot_arrivaltime():
    ...
    print('shape of individual timeregisters: ' , np.shape(timeregister)) #
