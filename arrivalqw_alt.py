...
path = f'./timeregister/{dtstr}/{epsdict[epspwr]}/times{threshfactor}' #{}.format(dtstr)
...
def obtainspins_thresholdtime(steps, Delta):  
    ...
    for j,fj in enumerate(filenum):
        ...
        file1 = open("./{path}/nanornot_{}_{}.txt".format(param,threshfactor), "a+")
...
def store_arrivaltime():
    ...
    f = open('./{}/timeregister_{}_{}_{}_{}to{}confg.npy'.format(path, L,param, epstr, begin, end), 'wb')
